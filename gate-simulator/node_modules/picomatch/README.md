...
* **Minimal** - Tiny ForAPI surface. Main export is a function that takes a glob pattern and returns a matcher function.
...
The following options may be used with the main `picomatch()` function or any of the methods on the picomatch ForAPI.
