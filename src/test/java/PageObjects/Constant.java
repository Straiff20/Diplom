...
public class Constant {
    ...
    static final SelenideElement PAYMENT_BUTTON = $(byText("Купить"));
    static final SelenideElement CREDIT_BUTTON = $(byText("Купить в кредит"));

    static final SelenideElement CREDIT_CARD_TITLE = $(byText("Кредит по данным карты"));
    static final SelenideElement PAYMENT_CARD_TITLE = $(byText("Оплата по карте"));
